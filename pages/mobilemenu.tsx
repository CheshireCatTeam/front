...
const Home: NextPage = () => {
	...
	function AnimationText() {
		...
		let contactanimations = document.getElementsByClassName(
			'mobile-menu-contact-animation'
		)
	...
	return (
		<>
			...
			<div
				...
				style={{
					background: isDark ? color1 : color2,
					color: isDark ? color2 : color1,
				}}
			>
				<div className="max-w-[390px] pt-10 px-6 mx-auto uppercase min-h-[100vh] max-h-[844px] overflow-hidden">
					<motion.div exit="exit" className="content">
						<div className="relative w-full h-[25px] overflow-hidden">
							<motion.p
								variants={animation}
								className="mobile-menu-text-animation text-20 font-bold absolute top-[100px] left-0"
							>
								CHESHIRE CAT
							</motion.p>
						</div>
						...
						<motion.div className="mt-[40px] text-[50px]">
							<div
								className="relative w-full h-[77px] overflow-hidden"
								style={{
									borderBottom: `1px solid ${
										isDark ? color2 : color1
									}`,
								}}
							>
								<motion.p
									variants={animation}
									className="mobile-menu-text-animation font-normal absolute top-[100px] left-0"
								>
									<div className="flex items-start">
										<div className="text-[15px] mr-5 mt-4">
											01
										</div>
										<Link href={'/service'}>
											<a>Sevices</a>
							...
							<div className="mt-[46px] mb-10 text-[16px] flex">
								<div className="w-[220px]">
									<div className="relative h-[20px] overflow-hidden">
										<motion.p
											variants={animation}
											className="mobile-menu-contact-animation font-normal absolute top-[100px] left-0"
										>
											Behance
										</motion.p>
									</div>
						...
						<section id="footer">
							...
							>
								...
								<p
									...
									className="text-16 text-center mt-4 pb-8"
								>
									2022 Cheshire Cat
								</p>
							</motion.section>
