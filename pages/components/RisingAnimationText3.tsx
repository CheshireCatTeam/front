...
const RisingAnimationText3 = (props: any) => {
		...
		if (risingRef3.current) {
			if (
				window.pageYOffset +
					...
					risingRef3.current.clientHeight >
				risingRef3.current.offsetTop
			) {
				setShowText(true)
			}
		}
	...
	return (
		<motion.div
			exit="exit"
			ref={risingRef3}
			className="text-[100px] md:text-[170px] leading-[100px] md:leading-[170px] font-normal"
		>
			<div className="hidden xl:block w-full">
				<div className="animation-mask3 w-full">
					<motion.div
						variants={animation}
						className="animation-text3 w-full"
					>
													...
													<div className="btn-content-group mx-6">
														...
														>
															<path
																fillRule="evenodd"
																clipRule="evenodd"
																d="M0.65625 25.6875L0.65625 20.3125L106.406 20.3125V25.6875L0.65625 25.6875Z"
																fill={
																	props.isDark
																		? '#FF3D00'
																		: '#0019FF'
															...
															<rect
																width="33.7833"
																height="5.63055"
																transform="matrix(0.737805 -0.675013 -0.737805 -0.675013 87.0625 45.8438)"
																fill={
																	props.isDark
																		? '#FF3D00'
																		: '#0019FF'
															...
															<rect
																width="33.7835"
																height="5.63058"
																transform="matrix(-0.737843 -0.674972 -0.737843 0.674972 111.988 22.9611)"
																fill={
																	props.isDark
																		? '#FF3D00'
																		: '#0019FF'
			...
			<div className="xl:hidden w-full max-w-[540px] md:max-w-[900px] m-auto">
				<div className="animation-mask3 w-full">
					<motion.div
						variants={animation}
						exit="exit"
						className="animation-text3 w-full text-left"
					>
						Let’s
					</motion.div>
				</div>
				<div className="animation-mask3 w-full">
					<motion.div
						variants={animation}
						exit="exit"
						className="animation-text3 w-full text-right"
					>
						WRITE
					</motion.div>
				</div>
